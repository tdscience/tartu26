...
2. Revisit the London Cycle Hire data from session 3 and visualize flows using the `flowmapblue` package
...
To extend the analysis from session 3, prepare the cycle hire data as origin-destination flows with timestamps (e.g., from start/end stations and times). Then use `flowmapblue` for interactive visualization.
