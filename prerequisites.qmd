...
Alternatively, you can run the workshop materials using Posit Cloud or similar web services.
Note that for these cloud services, you may still need to install the required packages (see @sec-packages).
